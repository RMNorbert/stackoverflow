CREATE TABLE question(question_id serial PRIMARY KEY ,author INT,  title VARCHAR(100) NOT NULL, description TEXT, created TIMESTAMP NOT NULL);
...
INSERT INTO question(question_id,author,title,description,created) VALUES (1,1,'This','This is', NOW());
INSERT INTO question(question_id,author,title,description,created) VALUES (2,2,'Thisis','This is', NOW());
INSERT INTO question(question_id,author,title,description,created) VALUES (3,3,'Th','This is', NOW());
